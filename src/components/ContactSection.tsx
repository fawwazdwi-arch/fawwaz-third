...
const contactInfo = [
  {
    icon: Mail,
    label: 'Email',
    value: 'akunfffawwaz250@gmail.com',
    href: 'mailto:akunfffawwaz250@gmail.com',
  },
  {
    icon: Phone,
    label: 'Telepon',
    value: '+62 895-1083-6605',
    href: 'tel:+6289510836605',
  },
  {
    icon: MapPin,
    label: 'Lokasi',
    value: 'Banda Aceh, Indonesia',
    href: 'https://maps.app.goo.gl/E4BwjanWNM7vyuSU8',
  },
];
